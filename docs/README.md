...
샴페인 개수
2024 새해 이벤트에서 활용할 예정인 배지
총주문 금액 10,000원 이상부터 이벤트가 적용됩니다. <- 에러를 출력해야 될지, 할인 안된 가격을 적용해서 출력해야할지..
> 중복된 할인과 증정을 허용해서, 고객들이 혜택을 많이 받는다는 것을 체감할 수 있게 하는 것
> 올해 12월에 지난 5년 중 최고의 판매 금액을 달성
> 12월 이벤트 참여 고객의 5%가 내년 1월 새해 이벤트에 재참여하는 것

프로그램의 취지를 살펴보면 에러를 내뱉는게 맞는거 같다.
..라고 생각했는데 예시가 떡하니 8,500원이니 혜택 미적용시키고 계산하는게 맞네
